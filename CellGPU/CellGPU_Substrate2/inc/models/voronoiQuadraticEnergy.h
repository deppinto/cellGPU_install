...
class VoronoiQuadraticEnergy : public voronoiModelBase
    ...
    public:
        ...
        VoronoiQuadraticEnergy(int n,bool reprod);
        //! initialize with random positions and set all cells to have uniform target A_0 and P_0 parameters
        VoronoiQuadraticEnergy(int n, Dscalar A0, Dscalar P0,bool reprod);
        //!initialize with random positions in a square box
        VoronoiQuadraticEnergy(int n, bool reprod, Dscalar A0, Dscalar P0, Dscalar V0, int dx,  Dscalar IncrementationValue, int SubIntType);
        //!Blank constructor
