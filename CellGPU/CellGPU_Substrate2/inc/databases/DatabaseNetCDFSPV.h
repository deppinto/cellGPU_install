...
private:
    ...
    NcVar *posVar, *typeVar, *directorVar, *BoxMatrixVar, *timeVar, *means0Var,*exVar, *PrefPerimeterVar, *PrefAreaVar, *PrefSelfPropVar, *AdaptationTimeVar, *forceMaxVar; //!<NcVars we'll use
