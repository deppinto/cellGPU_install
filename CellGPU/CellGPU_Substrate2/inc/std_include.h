...
//!component-wise division of Dscalar2 by const
HOSTDEVICE Dscalar2 operator/(const Dscalar2 &a, const int &b)
    {
    return make_Dscalar2(a.x/b,a.y/b);
    }

//!component-wise multiplication of Dscalar2 by const
HOSTDEVICE Dscalar2 operator*(const Dscalar2 &a, const int &b)
    {
    return make_Dscalar2(a.x*b,a.y*b);
    }

//!component-wise addition of Dscalar2 by const
HOSTDEVICE Dscalar2 operator+(const Dscalar2 &a, const int &b)
    {
    return make_Dscalar2(a.x+b,a.y+b);
    }

//!component-wise subtraction of Dscalar2 by const
HOSTDEVICE Dscalar2 operator-(const Dscalar2 &a, const int &b)
    {
    return make_Dscalar2(a.x-b,a.y-b);
    }

//!component-wise division of Dscalar2 by Dscalar
HOSTDEVICE Dscalar2 operator/(const Dscalar2 &a, const Dscalar &b)
    {
    return make_Dscalar2(a.x/b,a.y/b);
    }

//!component-wise multiplication of Dscalar2 by Dscalar
HOSTDEVICE Dscalar2 operator*(const Dscalar2 &a, const Dscalar &b)
    {
    return make_Dscalar2(a.x*b,a.y*b);
    }

//!component-wise addition of Dscalar2 by Dscalar
HOSTDEVICE Dscalar2 operator+(const Dscalar2 &a, const Dscalar &b)
    {
    return make_Dscalar2(a.x+b,a.y+b);
    }

//!component-wise subtraction of Dscalar2 by Dscalar
HOSTDEVICE Dscalar2 operator-(const Dscalar2 &a, const Dscalar &b)
    {
    return make_Dscalar2(a.x-b,a.y-b);
    }
